...
class Worker extends Process
{
     ...
     * set onWorkerStart
     */
    public function setOnWorkerStart($onWorkerStart) {
     ...
     * set onWorkerStop
     */
    public function setOnWorkerStop($onWorkerStop) {
    ...
    public function hangup(Closure $closure) 
    {
        ...
        while(true)
        {
            ...
            // check pipeFile is exists or readable
            if(! file_exists($this->pipeFile) || ! is_readable($this->pipeFile)) $this->workerExit();
